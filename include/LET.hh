...
class G4Material;
class D1PrimaryGeneratorAction;
class D1DetectorConstruction;

class LET
{
private:
	LET(D1DetectorConstruction*);

public:
	~LET();
	static LET* GetInstance(D1DetectorConstruction*);
...
private:
	...
	//G4double *secondaryLetT,  *secondaryLetD;
