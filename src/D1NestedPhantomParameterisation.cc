...
// ********************************************************************
//
/// \file runAndEvent/D1/src/D1NestedPhantomParameterisation.cc
/// \brief Implementation of the D1NestedPhantomParameterisation class
//
//
///////////////////////////////////////////////////////////////////////////////
...
#include "../include/D1NestedPhantomParameterisation.hh"
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
D1NestedPhantomParameterisation::~D1NestedPhantomParameterisation(){
  fpZ.clear();
}
...
//
G4Material* D1NestedPhantomParameterisation
...
G4int D1NestedPhantomParameterisation::GetNumberOfMaterials() const{
  return fMat.size();
}
...
//
G4Material* D1NestedPhantomParameterisation::GetMaterial(G4int i) const{
  return fMat[i];
}
...
//
void D1NestedPhantomParameterisation
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//
// Dimensions are always same in this D1 example.
//
void D1NestedPhantomParameterisation
